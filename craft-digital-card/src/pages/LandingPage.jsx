...
const features = [
  ...
  { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a4 4 0 0 1 4 4v2a4 4 0 0 1-8 0V6a4 4 0 0 1 4-4z"/><path d="M9.5 14L3 20.5M14.5 14L21 20.5"/><circle cx="12" cy="14" r="3"/></svg>, title: 'AI Autofill', desc: 'Upload your resume and let AI instantly populate your card with your details' },
  { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>, title: 'Custom Logos', desc: 'Upload your company logo or personal brand mark for a professional touch' },
